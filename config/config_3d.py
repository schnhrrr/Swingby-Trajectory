...
from config.shared_parameters import x0_3d, xN_3d, v0_3d, vN_3d, ao_3d, t_colloc, t_total
...
kinematic3d_config = {
    ...
    "pinn": {
        ...
        "N_LAYERS": 3,
        "input_transform_fn": None,
        "output_transform_fn": partial(kinematic_3d, x0=x0_3d, xN=xN_3d, v0=v0_3d, vN=vN_3d),
    },
    "optimizer":{
        "ao_rgm": ao_3d,
        "t_colloc": t_colloc,
