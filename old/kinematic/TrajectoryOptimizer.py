...
class PINN(nn.Module):
    ...
    def __init__(self, N_INPUT, N_OUTPUT, N_NEURONS, N_LAYERS, phi, psi, R, R_dot, V):
        super().__init__()
...
class TrajectoryOptimizer:
    ...
    def __init__(self, model, ao_xyzgm, t_colloc, t_total, r0, r1, opt_lbfgs, opt_adam, n_lbfgs=100, n_adam=0, w_physics=1, quiver_scale=10, planet_size=200):
    ...
    def compute_thrust(self):
            ...
            self.v = torch.cat([vx,vy,vz],dim=1)
            self.a = torch.cat([ax,ay,az],dim=1)
