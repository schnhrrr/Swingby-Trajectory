...
class TrajectoryOptimizer:
    ...
    def __init__(self, model, ao_xyzgm, t_colloc, t_total, r0, r1, opt_lbfgs, opt_adam, n_lbfgs=150, n_adam=0, w_physics=.65, w_bc=160, quiver_scale=20, planet_size=200):
...
obj = TrajectoryOptimizer(pinn, ao_xyzgm, t_colloc, t_total, r0, r1, optimizer_lbfgs, optimizer_adam, n_adam=0, n_lbfgs=500, w_physics=1, w_bc=3.5)
